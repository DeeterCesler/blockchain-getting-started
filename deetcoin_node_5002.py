...
# -*- coding: utf-8 -*-
"""
Created on Thu Apr 11 22:09:00 2019
...
# Module 1 - getting started with blockchain
...
def mine_block():
    ...
    transaction = blockchain.add_transaction(sender = node_address, receiver = "your mom", amount = 1)
...
def is_valid():
    ...
    if is_valid:
        ...
        response = {'message': "Blockchain isn't legit."}
    return jsonify(response), 200
...
# replacing chain with longest chain if needed
...
def replace_chain():
    ...
    if is_chain_replaced:
        ...
        print("second")
        response = {'message': "All is normal - the current chain is the longest one.",
